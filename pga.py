...
for k in range(N):
    ...
    iut_slc_pga, phi_hat, rms = sas_tools.pga(iut_slc, win = 'custom', win_params = [10, 1])
    ...
    sas_tools.imwrite(np.hstack([iut_drc, vert_line, iut_drc_pga, vert_line, plot, vert_line, plot_rms]), os.path.join(output_dir, 'image_{}.png'.format(k)))
